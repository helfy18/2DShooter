...
public class Controller : MonoBehaviour
{
    ...
    [Tooltip("The rate at which the player is propelled forward when Side Scroller is selected")]
    public float propelSpeed = 0.5f;
    ...
    /// </summary>
    public enum MovementModes { MoveHorizontally, MoveVertically, FreeRoam, Astroids, SideScrolling };
    ...
    [Tooltip("The movmeent mode used by this controller:\n" +
        ...
        "Side Scrolling: Player is propelled in the X direction and is free to move vertically")]
    ...
    public bool propelX
    {
        get
        {
            return movementMode == MovementModes.SideScrolling;
        }
    }
